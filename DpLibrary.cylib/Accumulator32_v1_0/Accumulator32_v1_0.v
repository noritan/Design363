...
wire[3:0]       f0_empty;       // F0 is EMPTY
wire[3:0]       f0_not_full;    // F0 is NOT FULL
...
), .cy_dpconfig_d(
{
    ...
    `SC_WRK16CAT_DSBL /*CFG17-16: */
        ...
        /*  output  [03:00]                  */  .cmsb(),
        /*  output  [03:00]                  */  .so(),
        /*  output  [03:00]                  */  .f0_bus_stat(f0_not_full[3:0]),
        /*  output  [03:00]                  */  .f0_blk_stat(f0_empty[3:0]),
